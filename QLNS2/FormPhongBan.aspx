         ...
         <div class="card mb-4">
             ...
             <div class="card-body"><br />
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-6 mb-4">
                          <div class="pt-4">
                              <asp:LinkButton ID="btnThem" class="btn btn-primary me-sm-3 me-1" runat="server" Text="Thêm công tác" OnClick="btnThem_Click"><i class="fa fa-plus me-sm-2"></i> Thêm phòng ban </asp:LinkButton>
                              <asp:LinkButton ID="btnSua" class="btn btn-primary me-sm-3 me-1" runat="server" Text="Sửa công tác" OnClick="btnSua_Click"><i class="fa fa-edit me-sm-2"></i> Sửa phòng ban</asp:LinkButton>
                          </div>
                         <div class="pt-4">
                            <asp:LinkButton ID="btnXoa" class="btn btn-primary me-sm-3 me-1" runat="server" Text="Xóa công tác" OnClick="btnXoa_Click"><i class="fa fa-trash me-sm-2"></i> Xóa phòng ban</asp:LinkButton>
                            <asp:LinkButton ID="btnMoi" class="btn btn-primary me-sm-3 me-1" runat="server" Text="Làm mới"><i class="fa fa-arrows-rotate me-sm-2"></i>Làm mới</asp:LinkButton>
                        </div>
                      </div>
